...
class RealTimePerformanceMonitor:
    ...
    def get_agent_metrics(self, agent_id: str, limit: int = 100) -> List[AgentPerformanceMetrics]:
    ...
    def get_all_agent_metrics(self) -> Dict[str, List[AgentPerformanceMetrics]]:
        ...
        with self._lock:
            return {agent_id: list(metrics) for agent_id, metrics in self.agent_metrics.items()}
    ...
    def get_agent_performance_summary(self, agent_id: str, window_hours: int = 1) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            avg_task_time = sum(m.average_task_time for m in recent_metrics) / len(recent_metrics)
