# branch alignment executive summary
...
IF branch == "scientific":
    INCLUDE: Scientific/research-focused content for branch_alignment_executive_summary
    INCLUDE: Experimental features and methodologies
    INCLUDE: Advanced technical implementations
ELSE IF branch == "main":
    INCLUDE: Production-ready content for branch_alignment_executive_summary
