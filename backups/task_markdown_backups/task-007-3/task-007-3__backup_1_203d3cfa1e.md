...
Task 007.3 is complete when:

### Functional Requirements
- [ ] Migration status analyzed - Verification: [Method to verify completion] - Verification: [Method to verify completion]
- [ ] Branches categorized correctly - Verification: [Method to verify completion] - Verification: [Method to verify completion]
- [ ] Output includes migration field - Verification: [Method to verify completion] - Verification: [Method to verify completion]
- [ ] Statuses accurate - Verification: [Method to verify completion] - Verification: [Method to verify completion]
...
- [ ] Dependencies satisfied: 008.1, 008.2
...
### 007.3.1: **Define migration criteria**...
**Effort:** TBD
**Depends on:** None
**Priority:** medium
**Status:** pending
...
### 007.3.2: **Analyze branch structure**...
**Effort:** TBD
**Depends on:** None
**Priority:** medium
**Status:** pending
...
### 007.3.4: **Include in tool output**...
**Effort:** TBD
**Depends on:** None
**Priority:** medium
**Status:** pending
