...
class TestPythonVersionCheck:
    ...
    def test_compatible_version(self):
        ...
        with patch("launch.sys.version", "3.12.0"), \
...
class TestMainFunction:
    ...
    def test_main_setup_mode(self, mock_handle_setup, mock_install_uv, mock_parse, mock_check_version):
        ...
        with patch("launch.create_venv"):
            with patch("launch.setup_dependencies"):
                with patch("launch.download_nltk_data"):
                    with patch("launch.logger"):
                        main()
