...
class TestOrchestrationWorkflow:
    ...
    def test_worktree_sync_capability(self):
        ...
        expected_check = "git show-ref --verify --quiet refs/heads/orchestration-tools"
        assert expected_check in content, "Should check orchestration-tools branch exists"
