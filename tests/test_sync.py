...
class TestSyncConfiguration:
    ...
    def test_managed_files_include_essentials(self):
        ...
        for essential_file in essential_files:
            assert (
                essential_file in content
            ), f"Should include {essential_file} in managed files"
    ...
    def test_post_push_managed_files(self):
        ...
        if hook_path.exists():
            ...
            assert (
                "MANAGED_FILES=(" in content
            ), "post-push hook should define MANAGED_FILES"
...
class TestOrchestrationWorkflow:
    ...
    def test_worktree_sync_capability(self):
        ...
        ), "Should reference orchestration-tools branch"
