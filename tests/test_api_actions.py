...
def mock_ai_engine():
    ...
    with patch("server.python_backend.action_routes.ai_engine", new_callable=AsyncMock) as mock_ae:
        yield mock_ae
...
def test_extract_actions_from_text_success(client, mock_ai_engine):
    ...
    mock_action_item_data = [{
        ...
        "verb": "review", "object": "document", "raw_due_date_text": "by tomorrow",
    ...
    request_payload = {"subject": "Meeting Follow-up", "content": "Please review the document by tomorrow."}
