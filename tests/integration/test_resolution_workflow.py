...
from specification.template_generator import (  # noqa: E402
    SpecificationTemplateGenerator,
    SpecificationPhase,
)
from specification.interactive_creator import GuidedPromptSystem  # noqa: E402
from strategy.multi_phase_generator import MultiPhaseStrategyGenerator  # noqa: E402
...
class TestResolutionWorkflow:
    ...
    async def test_complete_specification_workflow(
        self,
        workflow_components,
    ...
    async def test_strategy_generation_integration(
        self, workflow_components, sample_conflict_data, sample_project_context
    ):
        ...
        strategies = strategy_generator.generate_multi_phase_strategies(
            sample_conflict_data, sample_project_context, "medium", "normal"
        )
    ...
    async def test_workflow_coordination(
        ...
        strategy_context = {
            ...
            "estimated_resolution_time": specification["template_metadata"].get(
                "estimated_time", 30
            ),
        }

        strategies = strategy_generator.generate_multi_phase_strategies(
            sample_conflict_data, strategy_context, "medium", "normal"
        )
    ...
    async def test_performance_integration(
        ...
        # Generate specification
        await template_generator.generate_specification_template(
            sample_conflict_data,
            sample_project_context,
            sample_team_context,
            SpecificationPhase.IMPROVED,
    ...
    async def test_error_propagation_integration(self, workflow_components):
        ...
        try:
            specification = await template_generator.generate_specification_template(
                invalid_conflict_data, invalid_context, {}, SpecificationPhase.IMPROVED
            )
    ...
    async def test_workflow_with_constitutional_violations(
        self,
        workflow_components,
        sample_conflict_data,
        sample_project_context,
    ...
    async def test_parallel_workflow_capabilities(
        self, workflow_components, sample_conflict_data, sample_project_context
    ):
    ...
    async def test_workflow_scalability(self, workflow_components):
        ...
        specification = await template_generator.generate_specification_template(
            large_conflict_data, large_project_context, {}, SpecificationPhase.IMPROVED
        )
    ...
    async def test_constitutional_framework_compliance(
        self,
        workflow_components,
        sample_conflict_data,
        sample_project_context,
        ...
        await constitutional_engine.load_constitutional_rules_from_directory(
