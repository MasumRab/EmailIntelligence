...
from resolution.constitutional_engine import (  # noqa: E402
...
class TestConstitutionalEngine:
    ...
    async def test_rule_registration(self, engine, sample_rules):
        ...
        result = engine.register_constitutional_rules(sample_rules)
    ...
    async def test_template_validation_basic(self, engine, sample_rules, sample_template_data):
        ...
        engine.register_constitutional_rules(sample_rules)
    ...
    async def test_performance_benchmarks(self, engine, sample_rules):
        ...
        large_template = {
            "template_content": {
                f"section_{i}": {f"content_{j}": f"Test content {i}-{j}" for j in range(10)}
                for i in range(50)
            }
        }
    ...
    async def test_rule_caching(self, engine, sample_rules):
        ...
        template_data = {"template_content": {"overview": {"quality_score": 0.8}}}
    ...
    async def test_error_handling(self, engine):
        ...
        invalid_template = {"invalid_field": "This doesn't match expected structure"}
    ...
    async def test_constitutional_framework_integration(self, engine, sample_rules):
        ...
        await engine.load_constitutional_rules_from_directory(
    ...
    async def test_custom_rule_function(self, engine):
        ...
        engine.register_constitutional_rules([custom_rule])
        ...
        invalid_template = {"template_content": {"section1": {"content": "data"}}}
