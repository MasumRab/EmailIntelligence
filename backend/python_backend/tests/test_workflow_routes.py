...
async def test_create_and_activate_new_workflow(client, mock_workflow_engine):
    ...
    assert response_create.json()["message"] == "Workflow 'my_brand_new_workflow' created successfully."
    ...
    mock_workflow_engine.create_and_register_workflow_from_config.assert_called_once_with(new_workflow_config)
