...
async def load_model(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"An unexpected error occurred while loading model '{model_name}'.")
...
async def unload_model(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"An unexpected error occurred while unloading model '{model_name}'.")