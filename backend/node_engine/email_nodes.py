...
class EmailSourceNode(BaseNode):
    ...
    async def execute(self, context: ExecutionContext) -> Dict[str, Any]:
        ...
        try:
            ...
            limit = int(self.inputs.get("limit", 100))
...
class FilterNode(BaseNode):
    ...
    async def execute(self, context: ExecutionContext) -> Dict[str, Any]:
        ...
        try:
            emails = self.inputs.get("emails", [])
            criteria = self.inputs.get("criteria", self.config.get("default_criteria", {}))
