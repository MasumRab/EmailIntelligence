...
class AuditLogger:
    ...
    def log_node_execution(
        ...
        """Log node execution."""
        self.logger.info(
            f"NODE_EXEC: workflow={workflow_id}, node_id={node_id}, name={node_name}, status={status}, duration={duration}s"
        )
...
class ResourceManager:
    ...
    async def acquire_resources(self, workflow_id: str, required_resources: ResourceLimits) -> bool:
        ...
        self.logger.info(
            f"Resources acquired for workflow {workflow_id}. Current: {self.current_workflows}/{self.max_concurrent_workflows}"
        )
        return True
    ...
    def release_resources(self, workflow_id: str):
        ...
        self.logger.info(
            f"Resources released for workflow {workflow_id}. Current: {self.current_workflows}/{self.max_concurrent_workflows}"
        )
