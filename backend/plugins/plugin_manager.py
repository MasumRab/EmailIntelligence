...
class PluginManager:
    ...
    def load_plugins(self) -> bool:
        ...
        try:
            ...
            for py_file in self.plugins_dir.glob("*.py"):
                ...
                try:
                    ...
                    for name, obj in inspect.getmembers(module):
                        if inspect.isclass(obj) and obj != BasePlugin and obj != UIComponentPlugin and obj != ProcessingNode:
            ...
            logger.info(f"Plugin loading completed. Total plugins: {len(self._plugins)}, "
