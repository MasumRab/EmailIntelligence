...
class PromptEngineer:
    ...
    def __init__(self, template: Optional[str] = None):
        ...
        if template:
            self.templates["default_template"] = template

    def fill(self, template_name: str = "default_template", **kwargs) -> str:
        """
        Fills the prompt template with the given keyword arguments.
        If template_name is not provided, it uses the default_template.
        """
    ...
    def execute(self, template_name: str = "default_template", **kwargs) -> str:
        """
        Fills the template and executes the prompt against an LLM.
        NOTE: This is a placeholder for LLM interaction.
        """
        prompt = self.fill(template_name=template_name, **kwargs)
