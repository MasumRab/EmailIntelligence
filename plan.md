...
```toml
# commands_temp/commands/refactor.toml
...
**Create:**
- `commands_temp/` directory structure
- `commands_temp/commands/refactor.toml`
- `commands_temp/active/parsers/toml_command_parser.py`
- `commands_temp/active/parsers/cli.py`
- `commands_temp/active/tests/test_toml_commands.py`
- `commands_temp/README.md`
- `commands_temp/MIGRATION.md`
