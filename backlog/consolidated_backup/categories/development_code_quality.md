...
**Source:** backlog/tasks/alignment/task-224 - Update-Alignment-Strategy-Address-Technical-Debt-in-Scientific-Branch-While-Preserving-Improvements.md
...
**Source:** backlog/tasks/alignment/task-83 - Implement-Git-Subtree-Pull-Process-for-Scientific-Branch.md
...
**Source:** backlog/tasks/alignment/task-85 - Test-and-Validate-Subtree-Integration-on-Both-Branches.md
...
**Source:** backlog/tasks/dashboard/phase2/task-223 - Phase-2.4-Implement-WebSocket-support-for-real-time-dashboard-updates-and-live-metrics-streaming.md
...
**Source:** backlog/tasks/dashboard/phase2/task-223 - Phase-2.6-Implement-dashboard-export-functionality-(CSV,-PDF,-JSON)-for-statistics-and-reports.md
...
**ID:** backlog/tasks/ai-nlp/task-231 - Global-State-Management-Refactoring.md
**Status:** Todo
**Priority:** High
...
**Source:** backlog/tasks/ai-nlp/task-231 - Global-State-Management-Refactoring.md
...
**Source:** backlog/tasks/architecture-refactoring/task-229 - Dependency-Management-Improvements.md
...
**Source:** backlog/tasks/architecture-refactoring/task-84 - Handle-ImportError-in-example.py-explicitly-or-ensure-proper-removal.md
...
**Source:** backlog/tasks/architecture-refactoring/task-237 - Implement-'name'-property-for-BasePlugin-subclasses.md
...
**Source:** backlog/tasks/architecture-refactoring/task-217 - Implement-CategoryCreate-model-fields-in-models.py-or-ensure-proper-removal.md
...
**Source:** backlog/tasks/architecture-refactoring/task-216 - Implement-cleanup-logic-in-dependencies.py-or-ensure-proper-removal.md
...
**Source:** backlog/tasks/architecture-refactoring/task-218 - Implement-custom-event-registration-in-email_visualizer_plugin.py-or-ensure-proper-removal.md
...
**Source:** backlog/tasks/database-data/task-227 - Implement-lazy-loading-strategy-that-is-more-predictable-and-testable.md
...
**Source:** backlog/tasks/database-data/task-224 - Implement-proper-dependency-injection-for-database-manager-instance.md
...
**Source:** backlog/tasks/dashboard/phase3/task-86 - Phase-3.7-Create-comprehensive-dashboard-API-for-programmatic-access-and-third-party-integrations.md
...
**Source:** backlog/tasks/architecture-refactoring/task-230 - Refactor-global-state-management-to-use-dependency-injection.md
...
**Source:** backlog/tasks/architecture-refactoring/task-242 - Refactor-to-eliminate-global-state-and-singleton-pattern.md
...
**Source:** backlog/tasks/architecture-refactoring/task-210 - Remove-hidden-side-effects-from-initialization.md
...
**Source:** backlog/tasks/other/task-220 - Task-1.5-Add-automated-error-recovery.md
...
**Source:** backlog/tasks/other/task-221 - Task-2.5-Develop-task-dependency-resolution.md
...
**Source:** backlog/tasks/ai-nlp/task-228 - Task-4.3-Set-up-automated-fix-suggestions.md
...
**Source:** backlog/tasks/other/task-230 - Task-6.1-Create-parallel-documentation-generation-templates.md
...
**Source:** backlog/tasks/other/task-124 - Test-Branch-Task-Migration.md
...
**Source:** backlog/tasks/other/task-164 - Test-Branch-Task-Migration-Copy.md
...
**ID:** backlog/deferred/task-238 - Backend-Migration-to-src.md
**Status:** Todo
**Priority:** Medium
...
**Source:** backlog/deferred/task-238 - Backend-Migration-to-src.md
...
**ID:** backlog/tasks/alignment/task-87 - Align-feature-branches-with-scientific.md
**Status:** 
**Priority:** Medium
...
**Source:** backlog/tasks/alignment/task-87 - Align-feature-branches-with-scientific.md
...
**ID:** backlog/tasks/architecture-refactoring/task-221 - Repository-Pattern-Enhancement.md
**Status:** Todo
**Priority:** Medium
...
**Source:** backlog/tasks/architecture-refactoring/task-221 - Repository-Pattern-Enhancement.md
...
**ID:** backlog/tasks/architecture-refactoring/task-231 - Module-System-Improvements.md
**Status:** Todo
**Priority:** Medium
...
**Source:** backlog/tasks/architecture-refactoring/task-231 - Module-System-Improvements.md
...
**ID:** backlog/tasks/architecture-refactoring/task-88 - Legacy-Code-Migration-Plan.md
**Status:** Todo
**Priority:** Medium
...
**Source:** backlog/tasks/architecture-refactoring/task-88 - Legacy-Code-Migration-Plan.md
...
**ID:** backlog/tasks/architecture-refactoring/task-85 - Code-Organization-Improvements.md
**Status:** Todo
**Priority:** Medium
...
**Source:** backlog/tasks/architecture-refactoring/task-85 - Code-Organization-Improvements.md
...
**ID:** backlog/tasks/database-data/task-221 - Complete-DatabaseManager-Class-Implementation.md
**Status:** Todo
**Priority:** Medium
...
**Source:** backlog/tasks/database-data/task-221 - Complete-DatabaseManager-Class-Implementation.md
...
**ID:** backlog/tasks/other/task-84 - Data-Protection-Enhancements.md
**Status:** Todo
**Priority:** Medium
...
**Source:** backlog/tasks/other/task-84 - Data-Protection-Enhancements.md
...
**Source:** backlog/tasks/ai-nlp/task-231 - Code-Quality-Refactoring-Split-large-NLP-modules,-reduce-code-duplication,-and-break-down-high-complexity-functions.md
...
**Subtasks:** task-238.1, task-238.2, task-238.4, task-238.5, task-238.3

**Source:** backlog/tasks/database-data/task-238 - Implement-EmailRepository-Interface.md
...
**Source:** backlog/tasks/dashboard/phase1/task-87 - Phase-1.11-Add-integration-tests-to-verify-dashboard-works-with-both-modular-and-legacy-data-sources.md
...
**Source:** backlog/tasks/dashboard/phase1/task-83 - Phase-1.13-Add-deprecation-warnings-and-migration-guide-for-legacy-dashboard-routes.md
...
**Source:** backlog/tasks/dashboard/phase4/task-226 - Phase-4.6-Add-disaster-recovery-capabilities-with-automated-backups-and-failover-for-dashboard-data.md
...
**Source:** backlog/deferred/task-238.5 - Sub-task-Final-Cleanup.md
...
**Source:** backlog/deferred/task-238.1 - Sub-task-Move-Backend-Files-to-src.md
...
**Source:** backlog/deferred/task-238.4 - Sub-task-Run-and-Fix-Tests.md
...
**Source:** backlog/deferred/task-238.2 - Sub-task-Update-Imports-and-References.md
...
**Source:** backlog/tasks/other/task-124 - UI-Enhancement-Implement-JavaScript-based-visual-workflow-editor-with-drag-and-drop-functionality.md
...
**ID:** backlog/tasks/ai-nlp/task-237 - AI-Engine-Modularization.md
**Status:** Todo
**Priority:** Low
...
**Source:** backlog/tasks/ai-nlp/task-237 - AI-Engine-Modularization.md
...
**ID:** backlog/tasks/dev-environment/task-87 - Development-Environment-Enhancements.md
**Status:** Todo
**Priority:** Low
...
**Source:** backlog/tasks/dev-environment/task-87 - Development-Environment-Enhancements.md
...
**Dependencies:** task-240, task-124, task-84, task-231

**Source:** backlog/tasks/database-data/task-223 - Complete-Repository-Pattern-Integration-with-Dashboard-Statistics.md
...
**Source:** backlog/tasks/ai-nlp/task-230 - Create-AI-Model-Training-Guide.md
...
**Source:** backlog/tasks/testing/task-82 - Create-Abstraction-Layer-Tests.md
...
**Source:** backlog/tasks/testing/task-84 - Create-Notmuch-Tests-for-Scientific.md
...
**Source:** backlog/tasks/other/task-82 - Create-Task-Verification-Framework.md
...
**Source:** backlog/tasks/dev-environment/task-230 - Fix-launch-bat-issues.md
...
**Source:** backlog/tasks/ai-nlp/task-82 - Implement-PromptEngineer-class-for-LLM-interaction-or-update-README.md
...
**Source:** backlog/tasks/dashboard/phase1/task-217 - Phase-1.5-Update-modules-dashboard-routes.py-to-use-new-DataSource-aggregation-methods.md
...
**Source:** backlog/tasks/dashboard/phase1/task-218 - Phase-1.6-Add-authentication-support-to-dashboard-routes-using-get_current_active_user-dependency.md
...
**Source:** backlog/tasks/dashboard/phase1/task-239 - Phase-1.7-Implement-time_saved-calculation-logic-(2-minutes-per-auto-labeled-email)-in-dashboard-routes.md
...
**Source:** backlog/tasks/dashboard/phase1/task-164 - Phase-1.8-Update-performance-metrics-calculation-to-work-with-new-aggregated-data-approach.md
...
**Source:** backlog/tasks/dashboard/phase1/task-84 - Phase-1.9-Update-modules-dashboard-__init__.py-registration-to-handle-authentication-dependencies-properly.md
...
**Source:** backlog/tasks/other/task-87 - Standardize-Dependency-Management-System.md
...
**Source:** backlog/tasks/database-data/task-223 - Complete-Database-Dependency-Injection-Alignment.md
...
**Source:** backlog/tasks/testing/task-82 - Fix-test-suite-issues.md
...
**Source:** backlog/tasks/ai-nlp/task-86 - Implement-AI-Lab-Interface-for-Scientific-Exploration.md
...
**Source:** backlog/tasks/deployment-ci-cd/task-231 - Implement-Scientific-UI-System-Status-Dashboard.md
...
**Source:** backlog/tasks/other/task-84 - Secure-SQLite-database-paths-to-prevent-path-traversal.md
...
**Source:** backlog/tasks/testing/task-82 - Testing-&-Documentation-Completion-Achieve-95%+-test-coverage-and-complete-comprehensive-documentation.md
...
**Source:** backlog/tasks/database-data/task-231 - Implement-SOLID-Email-Data-Source-Abstraction.md
