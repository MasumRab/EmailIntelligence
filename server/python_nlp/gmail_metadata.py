...
class GmailMetadataExtractor:
    ...
    def _extract_email_address(self, address_header: str) -> str:
        ...
        email_match = re.search(r'\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b', address_header)
        if email_match:
    ...
    def _extract_custom_headers(self, headers: Dict[str, str]) -> Dict[str, str]:
        ...
        standard_headers = {
            ...
            'Delivered-To', 'Received', 'Authentication-Results'
        }
    ...
    def extract_batch_metadata(self, gmail_messages: List[Dict[str, Any]]) -> List[GmailMessage]:
        ...
        for message in gmail_messages:
            try:
                ...
                self.logger.error(f"Failed to extract metadata for message {message.get('id', 'unknown')}: {e}")
