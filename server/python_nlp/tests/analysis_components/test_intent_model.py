...
class TestIntentModel(unittest.TestCase):
    ...
    def test_analyze_model_success(self):
        ...
        mock_sklearn_model.predict_proba.assert_called_once_with(["Could you please send the report?"])
    ...
    def test_analyze_model_fails_fallback_to_regex(self):
        ...
        analyzer = IntentModel(intent_model=mock_sklearn_model)
        result = analyzer.analyze("I have a question about the schedule.") # Regex keywords for inquiry/scheduling
