...
- [ ] T010 [US1] Implement the core narrative synthesis logic within a new `src/services/analysis_service.py`.
...
- [ ] T012 [US2] Implement the rebase detection logic in `src/services/analysis_service.py`, using the reflog access provided by the `git_wrapper`.
