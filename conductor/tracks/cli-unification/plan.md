...
- [~] Task 0.4: Rigorous DNA Scan (logic-compare) of all remote scripts (IN PROGRESS)
...
- [ ] Task 2.4: Port missing `TaskDeduplicator` logic from `orchestration-tools`
- [ ] Task 2.5: Integrate `backlog/relationships` logic for task linking
...
- [ ] Task 3.4: Port `find_lost_files` and dangling commit recovery logic
...
- [ ] Task 4.3: Implement `ImportAuditCommand` auto-fix (--fix) logic
