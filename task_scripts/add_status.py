...
ensuring all tasks have proper status values for the production validator.
"""
...
def add_status_to_task_file(filepath: str) -> bool:
    """Add status to all tasks in a task file"""
    try:
...
def process_directory(directory: str, pattern: str = "**/tasks.json"):
    ...
    for task_file in task_files:
        ...
        if add_status_to_task_file(str(task_file)):
            success_count += 1
