...
def create_sample_task_file():
    ...
    sample_tasks = {
        "tasks": [
            ...
            {"id": 2, "title": "Sample Task 2", "status": "in-progress", "dependencies": [1]},
            {"id": 3, "title": "Sample Task 3", "status": "completed"},
        ]
    }
...
def demonstrate_basic_usage():
    ...
    print(
        "   python task_validator_fixer_production.py --batch sample_tasks.json corrupted_tasks.json"
    )
...
def main():
    ...
    print("  - sample_tasks.json (valid tasks)")
    print("  - corrupted_tasks.json (invalid tasks for testing)")
    print("  - task_validator_fixer_production.py (the validator script)")
    print("  - task_validator_fixer_security_analysis.md (security details)")
    print("  - task_validator_fixer_security_summary.md (security summary)")
