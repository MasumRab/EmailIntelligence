...
class Neo4jConnectionManager:
    ...
    async def execute_write_transaction(self, tx_function, *args, database: str = "neo4j") -> Any:
...
async def initialize_database_schema() -> None:
    ...
    for index_name, property_name, node_label in indexes:
        try:
            ...
            logger.warning(
                "Index creation failed", name=index_name, property=property_name, label=node_label, error=str(e)
            )
