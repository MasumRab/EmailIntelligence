...
class GraphTraversalEngine:
    ...
    async def breadth_first_search(
        ...
        self.performance_stats["avg_execution_time"] = (
            (self.performance_stats["avg_execution_time"] * (self.performance_stats["total_traversals"] - 1) + 
             result.execution_time) / self.performance_stats["total_traversals"]
        )
        
        logger.info("BFS traversal completed",
    ...
    async def bidirectional_search(
        ...
        logger.info("Starting bidirectional search",
                   start_node=start_node_id,
        ...
        logger.info("Bidirectional search completed without finding target",
                   nodes_visited=result.nodes_visited,
                   execution_time=result.execution_time)
    ...
    async def find_shortest_path(
        ...
        return await self.bidirectional_search(
            start_node_id, start_node_type, target_node_id, 
            relationship_types, max_depth
        )
