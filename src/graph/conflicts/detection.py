...
from ...models.graph_entities import (
    PullRequest, Conflict, ConflictType, ConflictSeverity, 
    File, Commit, FileChange
)
...
class ConflictDetectionEngine:
    ...
    async def detect_merge_conflicts(
        ...
        logger.info("Merge conflict detection completed", 
    ...
    async def detect_dependency_conflicts(
        ...
        for pr_id in pr_ids:
            ...
            for cycle in cycles:
                dependency_conflicts.append(DependencyConflict(
    ...
    async def detect_semantic_conflicts(
        ...
        detection_time = time.time() - start_time
        logger.info("Semantic conflict detection completed",
    ...
    async def detect_resource_conflicts(
        ...
        detection_time = time.time() - start_time
        logger.info("Resource conflict detection completed",
