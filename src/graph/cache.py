...
class GraphPerformanceMonitor:
    ...
    def clear_acknowledged_alerts(self):
        ...
        logger.info("Cleared acknowledged alerts",
    ...
    def get_system_health(self) -> Dict[str, Any]:
        ...
        if query_times:
            ...
            if avg_query_time > 2.0:
                health_status["overall"] = "critical" if health_status["overall"] == "healthy" else health_status["overall"]
        ...
        health_status["components"] = {
            ...
            "query_performance": "healthy" if len([a for a in critical_alerts if "query" in a["metric"]]) == 0 else "critical",
            "traversal": "healthy" if len([a for a in critical_alerts if "traversal" in a["metric"]]) == 0 else "critical"
        }
...
async def get_cached_traversal_result(
    operation: str,
    parameters: Dict[str, Any]
) -> Optional[Any]:
    """Get cached traversal result"""
