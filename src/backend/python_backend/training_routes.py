...
async def start_training(
    ...
    current_user: str = fastapi.Depends(get_current_active_user),
):
    """
...
async def get_training_status(job_id: str, current_user: str = fastapi.Depends(get_current_active_user)):
    """
