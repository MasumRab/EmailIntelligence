...
async def test_security_features():
    ...
    print(f"EmailSourceNode trusted: {security_manager.validate_node_execution('EmailSourceNode', dict())}")
    print(f"PreprocessingNode trusted: {security_manager.validate_node_execution('PreprocessingNode', dict())}")
