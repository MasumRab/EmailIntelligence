...
class CommitReorderer:
    ...
    def suggest_order(self, commits: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
        Suggest an ordering that groups commits by module.

        Groups commits by their primary affected module and orders them
        according to a predefined priority list (core, utils, git, etc.).
        """
