...
class Mutation(ObjectType):
    ...
    update_ai_settings = Boolean(
        rate_limit_rpm=Int(), cache_ttl=Int(), temperature=Float(), circuit_breaker_threshold=Int()
    )
    ...
    update_fictionality_settings = Boolean(sensitivity=Float(), cache_ttl=Int(), custom_prompts=graphene.JSONString())
