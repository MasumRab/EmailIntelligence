                    ...
                    "beginner": {
                        "questions": [
                            ...
                            },
                            {
                                ...
                                "options": ["Low - can wait for thorough analysis", "Medium - important but not critical", "High - needs quick resolution"],
                        ...
                        "questions": [
                            {
                                ...
                                "options": ["Content conflict - different implementations", "Structural conflict - code organization", "Architectural conflict - system design", "Dependency conflict - imports/versions", "Semantic conflict - business logic"],
                                "validation": "single_option",
                    ...
                    "expert": {
                        "questions": [
                            ...
                            },
                            {
                                ...
                                "options": ["Conservative - minimize risk even if slower", "Moderate - balance speed and safety", "Aggressive - optimize for speed with controlled risk"],
                                "validation": "single_option",
                ...
                "questions": [
                    {
                        ...
                        "options": ["Basic - essential rules only", "Standard - recommended compliance", "Strict - full compliance validation"],
                        "validation": "single_option",
                    ...
                    },
                    {
                        ...
                        "options": ["Constitutional validation", "Code quality checks", "Performance validation", "Security scanning", "Documentation review"],
                ...
                "questions": [
                    {
                        ...
                        "options": ["Sequential - step by step with validation", "Parallel - multiple approaches simultaneously", "Hybrid - combination of both"],
                        "validation": "single_option",
                    ...
                    },
                    {
                        ...
                        "options": ["Automated - full automatic rollback", "Semi-automated - guided rollback process", "Manual - full control over rollback"],
                        "validation": "single_option",
