...
class OptimizedPerformanceMonitor:
    ...
    # Added for compatibility with legacy logging calls
    def log_performance(self, log_entry: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.record_metric(name=name, value=duration, unit="ms")
        except Exception as e:
            logger.warning(f"Failed to record metric via log_performance: {e}")
