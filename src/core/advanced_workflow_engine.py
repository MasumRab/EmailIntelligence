...
try:
    from .security import SecurityManager, SecurityContext, SecurityLevel, Permission, DataSanitizer
...
class WorkflowExecutionResult:
    ...
    def __init__(self, workflow_id: str, status: str, execution_time: float, 
                 node_results: Dict[str, Any], error: Optional[str] = None):
        self.workflow_id = workflow_id
        self.status = status
...
class WorkflowRunner:
    ...
    def __init__(self, node_registry: Dict[str, type], max_concurrent_nodes: int = 5, security_context: Optional[SecurityContext] = None):
