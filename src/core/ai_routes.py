...
async def analyze_email(
    request: AIAnalysisRequest, current_user: str = Depends(get_current_active_user)
):
    """
...
async def categorize_email(
    request: AICategorizeRequest, current_user: str = Depends(get_current_active_user)
):
    """
...
async def validate_ai_models(current_user: str = Depends(get_current_active_user)):
    """
