...
async def rollback_model_version(
    ...
    try:
        ...
        if not success:
            raise HTTPException(status_code=400, detail=f"Failed to rollback model {model_id} to version {version}")
