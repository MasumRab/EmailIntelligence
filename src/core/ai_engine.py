...
# Module-level constants for analysis to avoid recreation
...
INTENT_QUESTION_WORDS = ["?", "what", "how", "when", "where", "why"]
INTENT_REQUEST_WORDS = ["please", "can you", "would you", "help"]
INTENT_APOLOGY_WORDS = ["sorry", "apologize", "mistake"]
INTENT_GRATITUDE_WORDS = ["thank", "appreciate", "grateful"]
...
class ModernAIEngine(BaseAIEngine):
    ...
    async def analyze_email(
        ...
        try:
            ...
            # Precompute lowercase text for fallback analysis to avoid repeated .lower() calls
    ...
    def _simple_sentiment_analysis(self, text: str, text_lower: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _rule_based_topics(self, text: str, text_lower: Optional[str] = None) -> List[str]:
    ...
    def _simple_intent_analysis(self, text: str, text_lower: Optional[str] = None) -> Dict[str, Any]:
        """Simple intent analysis based on keywords."""
        if text_lower is None:
            text_lower = text.lower()

        if any(word in text_lower for word in INTENT_QUESTION_WORDS):
            intent_type = "question"
        elif any(word in text_lower for word in INTENT_REQUEST_WORDS):
            intent_type = "request"
        elif any(word in text_lower for word in INTENT_APOLOGY_WORDS):
            intent_type = "apology"
        elif any(word in text_lower for word in INTENT_GRATITUDE_WORDS):
    ...
    def _simple_urgency_analysis(self, text: str, text_lower: Optional[str] = None) -> Dict[str, Any]:
