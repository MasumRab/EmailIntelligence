...
<<<<<<< HEAD
            # Pre-compute lowercase text for fallback analysis to improve performance
            full_text_lower = full_text.lower()

            # Perform analysis using available models
            # Pass full_text_lower to internal methods to avoid re-computation in fallback paths
