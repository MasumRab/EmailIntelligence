...
>>>>>>> f92b72e (feat: Enhance core system with security, database backups, and performance improvements)
    ...
    #     return None
        ...
        existing_user = await self.get_user_by_username(user_data.get("username", ""))        if existing_user:
            return None
