...
class DatabaseManager(DataSource):
    ...
    async def search_emails_with_limit(self, search_term: str, limit: int = 50) -> List[Dict[str, Any]]:
        ...
        # Use sorted cache to maintain order and avoid re-sorting later
        source_emails = self._get_sorted_emails()
        ...
        # Since we iterated over sorted emails, the results are already sorted.
        # We can skip the expensive sort operation.
