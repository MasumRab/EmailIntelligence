    ...
    async def validate_standard_resolution(
        ...
        **kwargs,
        ...
        try:
            ...
            overall_score = (
                constitutional_score + preservation_score + basic_result.overall_score
            ) / 3
    ...
    async def _validate_constitutional_compliance(
        ...
        try:
                    ...
                    issues.append(
                        {
                            ...
                            "severity": "major",
                            "description": (
                                "Some resolution steps may violate constitutional requirements"
                            ),
                        }
                    )
            ...
            if resolution_strategy.rollback_strategy:
                rollback_compliance = self._validate_rollback_compliance(
                    resolution_strategy.rollback_strategy
                )
                    ...
                    issues.append(
                        {
                            ...
                            "severity": "major",
                            "description": (
                                "Rollback strategy may not meet constitutional standards"
                            ),
                        }
                    )
            ...
            return {
                ...
                "components": {
                    ...
                    "specification_compliance": (
                        score_components[3] if len(score_components) > 3 else 0.5
                    ),
                },
            }
                ...
                "issues": [
                    {
                        ...
                        "message": f"Constitutional validation failed: {str(e)}",
                    }
                ],
            }
    ...
    async def _analyze_feature_preservation(
        ...
        try:
            ...
            if resolution_strategy.rollback_strategy:
                ...
                if any(
                    keyword in rollback_lower
                    for keyword in ["feature", "enhancement", "functionality"]
                ):
            ...
            return {
                ...
                "issues": [
                    {
                        "type": "analysis_error",
                        "message": f"Feature preservation analysis failed: {str(e)}",
                    }
                ],
            }
    ...
    def _generate_standard_recommendations(
        ...
        for issue in constitutional_result.get("issues", []):
            if issue.get("type") == "constitutional_non_compliance":
                recommendations.append(
                    "Review and modify strategy to meet constitutional requirements"
                )
