...
def test_quality_reports():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        assert reports[0].suggestions[0] == "Consider alternative translation", "Suggestion should match"
        ...
        assert metrics['segments_with_quality_reports'] == 1, "Should have 1 reported segment"
...
def test_translation_memory_stats():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        assert abs(stats['average_confidence'] - 0.9) < 0.01, "Average confidence should be ~0.9"
...
def test_agent_translation_stats():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        assert stats['total_segments_translated'] == 2, "Should have translated 2 segments"
        assert abs(stats['average_confidence'] - 0.85) < 0.01, "Average confidence should be ~0.85"
