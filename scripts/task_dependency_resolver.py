...
class TaskDependencyGraph:
    ...
    def remove_dependency(self, task_id: str, dependency_id: str):
        ...
        if (
            dependency_id in self.dependents
            and task_id in self.dependents[dependency_id]
        ):
    ...
    def get_ready_tasks(self) -> List[Task]:
        ...
        for task_id, task in self.tasks.items():
            if (
                ...
                and task_id not in self.in_progress_tasks
                and self.is_task_ready(task_id)
            ):
    ...
    def get_blocked_tasks(self) -> List[Task]:
        ...
        for task_id, task in self.tasks.items():
            if (
                task_id not in self.completed_tasks
                and task_id not in self.in_progress_tasks
                and not self.is_task_ready(task_id)
            ):
