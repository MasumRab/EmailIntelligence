...
class DependencyVerifier:
    ...
    def generate_conditional_requirements(self) -> str:
        ...
        # Helper for newlines in f-strings (Python < 3.12 compatibility)
        nl = "\n"
        nl_comment = "\n# "
