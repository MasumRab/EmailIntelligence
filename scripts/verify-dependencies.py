...
class DependencyVerifier:
    ...
    def generate_conditional_requirements(self) -> str:
        ...
        # Helper variables for f-strings to avoid backslashes (Python < 3.12 compatibility)
        newline = "\n"
        comment_newline = "\n# "
