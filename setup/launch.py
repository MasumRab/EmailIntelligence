...
# Python version checking is imported from setup.validation


# Environment validation functions are imported from setup.validation
...
def prepare_environment(args):
    ...
    if not args.no_venv:
        # Try conda first - activation should be done manually before running
