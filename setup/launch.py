...
try:
    ...
    # Only warn if not running test discovery to keep stderr clean for orchestration-tools tests
    if "pytest" not in sys.modules and not any("test_launch.py" in arg for arg in sys.argv) and not os.environ.get("PYTEST_CURRENT_TEST"):
