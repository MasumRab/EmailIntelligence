...
from src.core.container import get_container, initialize_all_services, cleanup_all_services
...
def main():
    ...
    test_parser.add_argument('--continue-on-error', action='store_true', help='Continue running tests even if some fail')
    ...
    parser.add_argument('--stage', choices=['dev', 'test'], default='dev', help='Application mode (legacy)')
...
def _add_legacy_args(parser):
    ...
    # Advanced Options
    parser.add_argument("--system-info", action="store_true", help="Print system information then exit.")
