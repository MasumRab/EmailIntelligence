...
# Add project root to sys.path so that `from setup.*` imports work
# when running as a script (python3 setup/launch.py)
import sys
import os
...
from setup.utils import print_system_info, process_manager, is_conda_available
