...
# Try to import container services
try:
    from setup.container import initialize_all_services
except ImportError:
    def initialize_all_services(container):
        """Fallback if container module is missing."""
        logging.getLogger(__name__).warning("Container services not available.")
