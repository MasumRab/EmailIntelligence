...
## Executive Summary
This document provides a comprehensive framework for conducting performance analysis and optimization. When code is provided, this framework will systematically analyze it across multiple performance dimensions to identify bottlenecks and recommend optimizations.
...
## 4. Profiling Analysis Framework

### CPU Profiling Analysis Template
...
### Memory Profiling Analysis Template
...
### Network Profiling Analysis Template
...
--------------------------|---------|---------|--------
Initial Page Load         | < 3s    | 4.2s    | [X] Over
Time to Interactive       | < 5s    | 6.1s    | [X] Over
JavaScript Bundle Size    | < 200KB | 500KB   | [X] Over
API Response Time (p95)   | < 500ms | 350ms   | [OK] Good
Database Query Time (p95) | < 100ms | 80ms    | [OK] Good
Memory Usage              | < 100MB | 150MB   | [X] Over
```

## 8. Performance Analysis Output Format

When code is provided, the analysis will include:
...
### Medium Confidence
- Likely performance issue based on patterns
...
This framework provides a systematic approach to evaluating performance when code is provided, with specific criteria for identifying bottlenecks and recommending optimizations based on their impact and feasibility.